...
registerGenerator('Pavage pentagonal de type 1', pentagonalTilingType1Gen, { type: ParameterType.NUMBER, name: 'Longueur 1', default: 200 }, { type: ParameterType.NUMBER, name: 'Longueur 2', default:120}, { type: ParameterType.NUMBER, name: 'Longueur 3', default: 150}, { type: ParameterType.NUMBER, name: 'Longueur 4', default: 70 }, { type: ParameterType.NUMBER, name: 'Angle 1 (DEG)', default:50}, { type: ParameterType.NUMBER, name: 'Angle 2 (DEG)', default:150}, { type: ParameterType.NUMBER, name: 'Scale', default: 100}, { type: ParameterType.COLOR, name: 'Couleur des traits', default: consColor(0, 0, 0) }, { type: ParameterType.COLOR, name: 'Couleur principale', default: consColor(0, 255, 122) } );
