...
import { pavageCarreGen, pavageHexaGen, pavageTriangleGen, pavageCarreAdouciGen, pavageGrandRhombitrihexagonalGen } from '../common/generators/tiling';
...
const img = pavageGrandRhombitrihexagonalGen();
